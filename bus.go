...
type Bus struct {
	...
	halted         bool
	screenDisabled bool // for automated tests
	alwaysVblank   bool // LY will always return 0x90, for when it's useful
}
...
func NewBus(cart *Cart) *Bus {
	...
	bgFIFO := NewFIFO()
	b.ppu.bgFIFO = bgFIFO
	b.lcd.SetBgFIFO(bgFIFO)
	objFIFO := NewFIFO()
	b.ppu.objFIFO = objFIFO
	b.lcd.SetObjFIFO(objFIFO)
...
func (b *Bus) ReadIO(addr uint16) byte {
	...
	case 0xFF06:
		return b.clock.TMA
	case 0xFF07:
		return b.clock.TAC&0x7 | 0xF8
	case 0xFF0F:
		return b.cpu.IF | 0xE0
		//  // case 0xFF1C:
		//  //   return b.NR32
	case 0xFF10:
		// Channel 1 audio
