...
type Instruction struct {
	Op       string
	DataType datatype
	To       string // Where result is stored
	From     string // 2nd value is taken from here, but not stored here. The name 'From' might be weird for SUB but whatever
	Flag     string
	// Len      int
}
...
var mainLookup map[byte]Instruction = map[byte]Instruction{
	...
	0x28: Instruction{Op: "JR", DataType: E8, Flag: Z},               // Jump by e8 if Z == 1
	...
	0x2E: Instruction{Op: "LD", DataType: A8, To: L, From: m8},       // LD L, n8
	...
	0x34: Instruction{Op: "INC", DataType: NODATA, To: mHL},          // INC [HL]
	0x35: Instruction{Op: "DEC", DataType: NODATA, To: mHL},          // DEC [HL]
	0x36: Instruction{Op: "LD", DataType: N8, To: mHL},               // LD [HL], n8
	0x37: Instruction{Op: "SCF", DataType: NODATA},                   // SCF
	0x38: Instruction{Op: "JR", DataType: E8, Flag: C},               // Jump by e8 if c == 1
	...
	0x76: Instruction{Op: "LD", DataType: NODATA, To: mHL, From: mHL},  // LD [HL], [HL]
	...
	0xC3: Instruction{Op: "JP", DataType: A16, From: m16},            // JP a16
  0xC4: Instruction{Op: "CALL", DataType: A16, Flag: NZ, From: m16},            // CALL NZ, a16
	...
	0xC7: Instruction{Op: "RST", DataType: NODATA, From: "0x00"},     // RST 0x00
	0xC8: Instruction{Op: "RET", DataType: NODATA, Flag: Z},          // RET Z
	0xC9: Instruction{Op: "RET", DataType: NODATA},                   // RET
	0xCA: Instruction{Op: "JP", DataType: A16, From: m16, Flag: Z},   // JP Z, a16
	0xCB: Instruction{Op: "PREFIX", DataType: NODATA},                // PREFIX
  0xCC: Instruction{Op: "CALL", DataType: A16, Flag: Z, From: m16},            // CALL Z, a16
	0xCD: Instruction{Op: "CALL", DataType: A16, From: m16},          // CALL a16
	0xCE: Instruction{Op: "ADC", DataType: N8, To: A},                // ADC A, n8
	0xCF: Instruction{Op: "RST", DataType: NODATA, From: "0x08"},   // RST 0x08
  ...
  0xD4: Instruction{Op: "CALL", DataType: A16, Flag: NC, From: m16},            // CALL NC, a16
	...
	0xD7: Instruction{Op: "RST", DataType: NODATA, From: "0x10"},   // RST 0x10
	0xD8: Instruction{Op: "RET", DataType: NODATA, Flag: C},         // RET C
	0xD9: Instruction{Op: "RETI", DataType: NODATA},                  // RETI
	0xDA: Instruction{Op: "JP", DataType: A16, From: m16, Flag: C},  // JP C, a16
	0xDB: Instruction{Op: "ILLEGAL", DataType: NODATA},             // ILLEGAL
	0xDC: Instruction{Op: "CALL", DataType: A16, Flag: C, From: m16}, // CALL C, a16
	0xDD: Instruction{Op: "ILLEGAL", DataType: NODATA},             // ILLEGAL
	0xDE: Instruction{Op: "SBC", DataType: N8, To: A},              // SBC A, n8
	0xDF: Instruction{Op: "RST", DataType: NODATA, From: "0x18"},   // RST 0x18
	...
	0xE7: Instruction{Op: "RST", DataType: NODATA, From: "0x20"},   // RST 0x20 (CALL, but 1 byte instead of 3)
  0xE8: Instruction{Op: "ADD", DataType: E8, To: SP}, // ADD SP, e8 
	...
	0xEF: Instruction{Op: "RST", DataType: NODATA, From: "0x28"},   // RST 0x28
	...
	0xF7: Instruction{Op: "RST", DataType: NODATA, From: "0x30"},   // RST 0x30
  ...
  0xF9: Instruction{Op: "LD", DataType: NODATA, To: SP, From: HL}, // LD SP, HL
	...
	0xFE: Instruction{Op: "CP", DataType: N8, To: A, From: m8},     // CP A, n8 (Sub n8 from A and update flags. Do not update A.)
	0xFF: Instruction{Op: "RST", DataType: NODATA, From: "0x38"},   // RST 0x38
}
...
func lookup(op byte, prefix bool) Instruction {
	...
	if prefix {
		...
		if !ok {
			log.Fatalf("unimplemented prefix opcode %02X", op)
		}
	} else {
		inst, ok = mainLookup[op]
		if !ok {
			log.Fatalf("unimplemented opcode %02X", op)
		}
	}
	if !ok {
